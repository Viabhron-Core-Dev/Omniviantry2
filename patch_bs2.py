...
# Change padding
content = content.replace("padding(bottom = 32.dp, top = 16.dp)", "padding(bottom = 16.dp, top = 8.dp)")
content = content.replace("Arrangement.spacedBy(16.dp)", "Arrangement.spacedBy(8.dp)")
content = content.replace("modifier = Modifier.padding(8.dp)", "modifier = Modifier.padding(4.dp)")
...
content = content.replace('"OmniRoute Dashboard"', '"AI Token Panel"')
